...
export  const userRoutes:Router=Router()
 ...
 userRoutes.patch("/:id",serializedUserDataMiddleware(updateUserSchema),ensureUserExistsMiddleware,ensureIsAdminMiddleware,ensureEmailNotExists,upDateUserController)
 userRoutes.delete("/:id",ensureUserExistsMiddleware,ensureTokenIsValidMiddleware,ensureIsAdminMiddleware,removeUserController)
